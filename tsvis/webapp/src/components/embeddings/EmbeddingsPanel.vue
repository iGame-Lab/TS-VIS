          ...
          <div class="infoContent">
            <div class="infoItem">
              <el-row type="flex" justify="space-between">
                <el-col :span="8">
                  <div>
                    <span
                      class="midFont">标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;签</span>
                  </div>
                </el-col>
                <el-col :span="16">
                  <div class="center">
                    <el-select v-model="curTag" class="tagSelect histmodeselect"
                      size="small" placeholder="请选择">
                      <el-option v-for="(item,index) in curTags" :key="index"
            ...
            <div class="infoItem">
              <el-row type="flex" justify="space-between">
                ...
                <el-col :span="16">
                  <div class="center">
                    <el-select v-model="curMethod"
                      class="tagSelect histmodeselect" size="small">
                      <el-option v-for="item in allMethods" :key="item.value"
            ...
            <div class="infoItem">
              <el-row type="flex" justify="space-between">
                ...
                <el-col :span="16">
                  <div class="center">
                    <el-select v-model="curDim" class="tagSelect histmodeselect"
                      size="small">
                      <el-option v-for="(item,index) in allDims" :key="index"
                        :value="item" :label="item" />
                    </el-select>
                  </div>
                </el-col>
            ...
            <div v-if="getReceivedQuestionInfo && getReceivedCurInfo"
              class="infoItem">
              <el-row type="flex" justify="space-around" class="row-bg">
                <el-col :span="6">
                  <el-button
                    :icon="playAction ? 'iconfont icon-zanting':'iconfont icon-ziyuan74'"
                    background-color="#736FBC" type="primary" size="medium"
                    @click="playActionClick()" />
                </el-col>
                <el-col :span="12">
                  <el-slider v-model="curStep" :min="curMin" :max="curMapMax"
                    :disabled="curMapMax===0" :show-tooltip="false"
                    input-size="small" class="rangeNumber" />
                </el-col>
                <el-col :span="6">
                  <div class="grid-content">
                    <span text-align="center"
                      class="midFont">{{ curMapStep }}/{{ curMax }}</span>
                  </div>
                </el-col>
              </el-row>
            </div>
            <div v-if="parseInt(curDim) > 3"
              class="infoItem ProbabilityDensitySec">
              <span class="ProbabilityDensity">概率密度</span>
              <hr>
              <el-checkbox-group v-model="checkedLabels" :max="2"
                class="leftInline-block">
                <el-checkbox v-for="(item,index) in lableTypes" :key="item"
                  :label="item" :class="'checkboxx'+index">{{ item }}
                </el-checkbox>
              </el-checkbox-group>
            </div>
            <div v-if="parseInt(curDim) > 3" class="infoItem">
              <el-row type="flex" justify="space-around" class="row-bg">
                ...
                <el-col :span="12">
                  <el-slider v-model="curLineWidth" :min="0.4" :max="2.0"
                    :show-tooltip="false" :step="0.1" input-size="small"
                    class="rangeNumber" />
                </el-col>
                <el-col :span="6">
                  <div class="grid-content">
                    <span text-align="center"
                      class="midFont">{{ curLineWidth.toFixed(1) }} / 2.0</span>
                  </div>
                </el-col>
              </el-row>
            </div>
        ...
        <div class="info">
          ...
          <div class="infoContent">
            <div class="infoItem">
              ...
              <el-card v-if="getMessage != ''" :body-style="{ padding: '0px' }"
                class="infoCard" display="none" align="middle">
                <div
                  v-if="getQuestionInfo[userSelectRunFile][getCurInfo.curTag]['sample']"
                  class="showBox" type="flex" align="middle">
                  ...
                  <div
                    v-if="getQuestionInfo[userSelectRunFile][getCurInfo.curTag]['sample_type'] == 'text' && getMessage != ''"
                    class="image">
                  ...
                  <div
                    v-if="getQuestionInfo[userSelectRunFile][getCurInfo.curTag]['sample_type'] == 'image' && getMessage != ''"
                    class="image">
                    <!-- <el-scrollbar style="height: 100%"> -->
                    <el-image :src="getPanelSampleData['url']"
                  ...
                  <div
                    ...
                    <customAudio
                      v-if="getQuestionInfo[userSelectRunFile][getCurInfo.curTag]['sample_type'] == 'audio' && getMessage != ''"
                      :theUrl="getPanelSampleData['url']" :index="1000"
