...
<template>
  <div class="imagecontainer">
    <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="8">
            ...
            <el-col :span="12">
              <div class="titleRight">
                ...
                <el-tooltip class="item" effect="dark"
                  ...
                  <span v-if="parentComponent" v-show="!checked"
                    class="checkedBox" @click="ischeckedLocal()">
                ...
                <span v-if="!parentComponent" class="checkedBox"
                  @click="ischecked()"><i
      ...
      <el-slider v-model="scrollvalue" :max="imagecontent.length - 1"
        :disabled="imagecontent.length - 1===0" :format-tooltip="formatTooltip"
        class="slider" />
    </el-col>
  </div>
</template>
