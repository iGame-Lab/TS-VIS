...
# source: tsvis/proto/tensor.proto
...
_TENSORSHAPEPROTO_DIM = _descriptor.Descriptor(
  name='Dim',
  full_name='tsvis.TensorShapeProto.Dim',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='tsvis.TensorShapeProto.Dim.size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='tsvis.TensorShapeProto.Dim.name', index=1,
...
_TENSORSHAPEPROTO = _descriptor.Descriptor(
  ...
  full_name='tsvis.TensorShapeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='tsvis.TensorShapeProto.dim', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='unknown_rank', full_name='tsvis.TensorShapeProto.unknown_rank', index=1,
...
_TENSORPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='dtype', full_name='tsvis.TensorProto.dtype', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tensor_shape', full_name='tsvis.TensorProto.tensor_shape', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='version_number', full_name='tsvis.TensorProto.version_number', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tensor_content', full_name='tsvis.TensorProto.tensor_content', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='half_val', full_name='tsvis.TensorProto.half_val', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='float_val', full_name='tsvis.TensorProto.float_val', index=5,
      ...
      serialized_options=b'\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='double_val', full_name='tsvis.TensorProto.double_val', index=6,
      ...
      serialized_options=b'\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='int_val', full_name='tsvis.TensorProto.int_val', index=7,
      ...
      serialized_options=b'\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='string_val', full_name='tsvis.TensorProto.string_val', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='scomplex_val', full_name='tsvis.TensorProto.scomplex_val', index=9,
      ...
      serialized_options=b'\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='int64_val', full_name='tsvis.TensorProto.int64_val', index=10,
      ...
      serialized_options=b'\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bool_val', full_name='tsvis.TensorProto.bool_val', index=11,
      ...
      serialized_options=b'\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dcomplex_val', full_name='tsvis.TensorProto.dcomplex_val', index=12,
...
TensorShapeProto = _reflection.GeneratedProtocolMessageType('TensorShapeProto', (_message.Message,), {
  ...
  'Dim' : _reflection.GeneratedProtocolMessageType('Dim', (_message.Message,), {
    ...
    '__module__' : 'tsvis.proto.tensor_pb2'
    # @@protoc_insertion_point(class_scope:tsvis.TensorShapeProto.Dim)
    })
  ,
  'DESCRIPTOR' : _TENSORSHAPEPROTO,
  '__module__' : 'tsvis.proto.tensor_pb2'
  # @@protoc_insertion_point(class_scope:tsvis.TensorShapeProto)
  })
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), {
  ...
  '__module__' : 'tsvis.proto.tensor_pb2'
  # @@protoc_insertion_point(class_scope:tsvis.TensorProto)
  })
