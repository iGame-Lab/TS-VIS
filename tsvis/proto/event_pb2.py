...
# source: tsvis/proto/event.proto
...
from tsvis.proto import summary_pb2 as tsvis_dot_proto_dot_summary__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='tsvis/proto/event.proto',
  package='tsvis',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x17tsvis/proto/event.proto\x12\x05tsvis\x1a\x19tsvis/proto/summary.proto\"\xa7\x02\n\x05\x45vent\x12\x11\n\twall_time\x18\x01 \x01(\x01\x12\x0c\n\x04step\x18\x02 \x01(\x03\x12\x16\n\x0c\x66ile_version\x18\x03 \x01(\tH\x00\x12\x13\n\tgraph_def\x18\x04 \x01(\x0cH\x00\x12!\n\x07summary\x18\x05 \x01(\x0b\x32\x0e.tsvis.SummaryH\x00\x12(\n\x0blog_message\x18\x06 \x01(\x0b\x32\x11.tsvis.LogMessageH\x00\x12(\n\x0bsession_log\x18\x07 \x01(\x0b\x32\x11.tsvis.SessionLogH\x00\x12\x37\n\x13tagged_run_metadata\x18\x08 \x01(\x0b\x32\x18.tsvis.TaggedRunMetadataH\x00\x12\x18\n\x0emeta_graph_def\x18\t \x01(\x0cH\x00\x42\x06\n\x04what\"\x90\x01\n\nLogMessage\x12&\n\x05level\x18\x01 \x01(\x0e\x32\x17.tsvis.LogMessage.Level\x12\x0f\n\x07message\x18\x02 \x01(\t\"I\n\x05Level\x12\x0b\n\x07UNKNOWN\x10\x00\x12\t\n\x05\x44\x45\x42UG\x10\n\x12\x08\n\x04INFO\x10\x14\x12\x08\n\x04WARN\x10\x1e\x12\t\n\x05\x45RROR\x10(\x12\t\n\x05\x46\x41TAL\x10\x32\"\xb1\x01\n\nSessionLog\x12/\n\x06status\x18\x01 \x01(\x0e\x32\x1f.tsvis.SessionLog.SessionStatus\x12\x17\n\x0f\x63heckpoint_path\x18\x02 \x01(\t\x12\x0b\n\x03msg\x18\x03 \x01(\t\"L\n\rSessionStatus\x12\x16\n\x12STATUS_UNSPECIFIED\x10\x00\x12\t\n\x05START\x10\x01\x12\x08\n\x04STOP\x10\x02\x12\x0e\n\nCHECKPOINT\x10\x03\"6\n\x11TaggedRunMetadata\x12\x0b\n\x03tag\x18\x01 \x01(\t\x12\x14\n\x0crun_metadata\x18\x02 \x01(\x0c\x62\x06proto3'
  ,
  dependencies=[tsvis_dot_proto_dot_summary__pb2.DESCRIPTOR,])



_LOGMESSAGE_LEVEL = _descriptor.EnumDescriptor(
  name='Level',
  full_name='tsvis.LogMessage.Level',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_SESSIONLOG_SESSIONSTATUS = _descriptor.EnumDescriptor(
  name='SessionStatus',
  full_name='tsvis.SessionLog.SessionStatus',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='wall_time', full_name='tsvis.Event.wall_time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='step', full_name='tsvis.Event.step', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='file_version', full_name='tsvis.Event.file_version', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='graph_def', full_name='tsvis.Event.graph_def', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='summary', full_name='tsvis.Event.summary', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='log_message', full_name='tsvis.Event.log_message', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='session_log', full_name='tsvis.Event.session_log', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tagged_run_metadata', full_name='tsvis.Event.tagged_run_metadata', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='meta_graph_def', full_name='tsvis.Event.meta_graph_def', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='what', full_name='tsvis.Event.what',
...
_LOGMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='level', full_name='tsvis.LogMessage.level', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='message', full_name='tsvis.LogMessage.message', index=1,
...
_SESSIONLOG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='tsvis.SessionLog.status', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='checkpoint_path', full_name='tsvis.SessionLog.checkpoint_path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='msg', full_name='tsvis.SessionLog.msg', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TAGGEDRUNMETADATA = _descriptor.Descriptor(
  ...
  full_name='tsvis.TaggedRunMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='tag', full_name='tsvis.TaggedRunMetadata.tag', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='run_metadata', full_name='tsvis.TaggedRunMetadata.run_metadata', index=1,
...
_EVENT.fields_by_name['summary'].message_type = tsvis_dot_proto_dot_summary__pb2._SUMMARY
...
Event = _reflection.GeneratedProtocolMessageType('Event', (_message.Message,), {
  'DESCRIPTOR' : _EVENT,
  '__module__' : 'tsvis.proto.event_pb2'
  # @@protoc_insertion_point(class_scope:tsvis.Event)
  })
...
LogMessage = _reflection.GeneratedProtocolMessageType('LogMessage', (_message.Message,), {
  ...
  '__module__' : 'tsvis.proto.event_pb2'
  # @@protoc_insertion_point(class_scope:tsvis.LogMessage)
  })
...
SessionLog = _reflection.GeneratedProtocolMessageType('SessionLog', (_message.Message,), {
  ...
  '__module__' : 'tsvis.proto.event_pb2'
  # @@protoc_insertion_point(class_scope:tsvis.SessionLog)
  })
...
TaggedRunMetadata = _reflection.GeneratedProtocolMessageType('TaggedRunMetadata', (_message.Message,), {
  ...
  '__module__' : 'tsvis.proto.event_pb2'
  # @@protoc_insertion_point(class_scope:tsvis.TaggedRunMetadata)
  })
