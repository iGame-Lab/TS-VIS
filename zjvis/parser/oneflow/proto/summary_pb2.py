...
# source: oneflow/proto/summary.proto
...
_SUMMARY_AUDIO = _descriptor.Descriptor(
  name='Audio',
  full_name='oneflow.Summary.Audio',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='sample_rate', full_name='oneflow.Summary.Audio.sample_rate', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='num_channels', full_name='oneflow.Summary.Audio.num_channels', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='length_frames', full_name='oneflow.Summary.Audio.length_frames', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encoded_audio_string', full_name='oneflow.Summary.Audio.encoded_audio_string', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='content_type', full_name='oneflow.Summary.Audio.content_type', index=4,
...
_SUMMARY_VALUE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tag', full_name='oneflow.Summary.Value.tag', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='oneflow.Summary.Value.metadata', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='simple_value', full_name='oneflow.Summary.Value.simple_value', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='image', full_name='oneflow.Summary.Value.image', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='histo', full_name='oneflow.Summary.Value.histo', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='audio', full_name='oneflow.Summary.Value.audio', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='projector', full_name='oneflow.Summary.Value.projector', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='oneflow.Summary.Value.tensor', index=7,
...
_SUMMARY_VALUE.fields_by_name['projector'].message_type = oneflow_dot_proto_dot_projector__pb2._PROJECTOR
_SUMMARY_VALUE.fields_by_name['tensor'].message_type = oneflow_dot_proto_dot_tensor__pb2._TENSORPROTO
...
HistogramProto = _reflection.GeneratedProtocolMessageType('HistogramProto', (_message.Message,), {
  ...
  '__module__' : 'oneflow.proto.summary_pb2'
...
Summary = _reflection.GeneratedProtocolMessageType('Summary', (_message.Message,), {
  ...
  'Audio' : _reflection.GeneratedProtocolMessageType('Audio', (_message.Message,), {
    ...
    '__module__' : 'oneflow.proto.summary_pb2'
    # @@protoc_insertion_point(class_scope:oneflow.Summary.Audio)
    })
  ,
