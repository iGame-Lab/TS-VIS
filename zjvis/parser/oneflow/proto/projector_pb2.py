...
# source: oneflow/proto/projector.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='oneflow/proto/projector.proto',
  package='oneflow',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x1doneflow/proto/projector.proto\x12\x07oneflow\"\xc2\x01\n\x06Tensor\x12\r\n\x05\x64type\x18\x01 \x01(\t\x12\x31\n\x0ctensor_shape\x18\x02 \x01(\x0b\x32\x1b.oneflow.Tensor.TensorShape\x12\x16\n\x0etensor_content\x18\x03 \x01(\x0c\x1a^\n\x0bTensorShape\x12,\n\x03\x64im\x18\x01 \x03(\x0b\x32\x1f.oneflow.Tensor.TensorShape.Dim\x1a!\n\x03\x44im\x12\x0c\n\x04size\x18\x01 \x01(\x03\x12\x0c\n\x04name\x18\x02 \x01(\t\"\xd5\x03\n\tProjector\x12\x31\n\tembedding\x18\x01 \x01(\x0b\x32\x1c.oneflow.Projector.EmbeddingH\x00\x12\x31\n\texception\x18\x02 \x01(\x0b\x32\x1c.oneflow.Projector.ExceptionH\x00\x1a+\n\tException\x12\x1e\n\x05value\x18\x01 \x01(\x0b\x32\x0f.oneflow.Tensor\x1a\xa9\x02\n\tEmbedding\x12\x33\n\x06sample\x18\x01 \x01(\x0b\x32#.oneflow.Projector.Embedding.Sample\x12\x1e\n\x05value\x18\x02 \x01(\x0b\x32\x0f.oneflow.Tensor\x12\x1e\n\x05label\x18\x03 \x01(\x0b\x32\x0f.oneflow.Tensor\x1a\xa6\x01\n\x06Sample\x12<\n\x04type\x18\x02 \x01(\x0e\x32..oneflow.Projector.Embedding.Sample.SampleType\x12\x1a\n\x01X\x18\x03 \x01(\x0b\x32\x0f.oneflow.Tensor\"B\n\nSampleType\x12\x14\n\x10TYPE_UNSPECIFIED\x10\x00\x12\t\n\x05\x41UDIO\x10\x01\x12\x08\n\x04TEXT\x10\x02\x12\t\n\x05IMAGE\x10\x03\x42\t\n\x07\x63ontentb\x06proto3'
)
...
_PROJECTOR_EMBEDDING_SAMPLE_SAMPLETYPE = _descriptor.EnumDescriptor(
  name='SampleType',
  full_name='oneflow.Projector.Embedding.Sample.SampleType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_TENSOR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tensor_shape', full_name='oneflow.Tensor.tensor_shape', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tensor_content', full_name='oneflow.Tensor.tensor_content', index=2,
...
_PROJECTOR_EXCEPTION = _descriptor.Descriptor(
  name='Exception',
  full_name='oneflow.Projector.Exception',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='oneflow.Projector.Exception.value', index=0,
...
_PROJECTOR_EMBEDDING_SAMPLE = _descriptor.Descriptor(
  name='Sample',
  full_name='oneflow.Projector.Embedding.Sample',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='oneflow.Projector.Embedding.Sample.type', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='X', full_name='oneflow.Projector.Embedding.Sample.X', index=1,
...
_PROJECTOR_EMBEDDING = _descriptor.Descriptor(
  name='Embedding',
  full_name='oneflow.Projector.Embedding',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='sample', full_name='oneflow.Projector.Embedding.sample', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='oneflow.Projector.Embedding.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='label', full_name='oneflow.Projector.Embedding.label', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROJECTOR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='embedding', full_name='oneflow.Projector.embedding', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='exception', full_name='oneflow.Projector.exception', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='content', full_name='oneflow.Projector.content',
...
Tensor = _reflection.GeneratedProtocolMessageType('Tensor', (_message.Message,), {
  ...
  'TensorShape' : _reflection.GeneratedProtocolMessageType('TensorShape', (_message.Message,), {
    ...
    'Dim' : _reflection.GeneratedProtocolMessageType('Dim', (_message.Message,), {
      ...
      '__module__' : 'oneflow.proto.projector_pb2'
...
Projector = _reflection.GeneratedProtocolMessageType('Projector', (_message.Message,), {
  ...
  'Exception' : _reflection.GeneratedProtocolMessageType('Exception', (_message.Message,), {
    ...
    '__module__' : 'oneflow.proto.projector_pb2'
    # @@protoc_insertion_point(class_scope:oneflow.Projector.Exception)
    })
  ,
  ...
  'Embedding' : _reflection.GeneratedProtocolMessageType('Embedding', (_message.Message,), {
    ...
    'Sample' : _reflection.GeneratedProtocolMessageType('Sample', (_message.Message,), {
      ...
      '__module__' : 'oneflow.proto.projector_pb2'
      # @@protoc_insertion_point(class_scope:oneflow.Projector.Embedding.Sample)
      })
    ,
    'DESCRIPTOR' : _PROJECTOR_EMBEDDING,
    '__module__' : 'oneflow.proto.projector_pb2'
    # @@protoc_insertion_point(class_scope:oneflow.Projector.Embedding)
    })
  ,
